<template>
    <div class="border-40 border-b p-8">
...
export default {
    ...
    methods: {
        init(platform) {
            ...
            var routingParameters = {
                ...
                transportMode: this.field.Transport_mode
                    ...
                    : "car",
                traffic: this.field.traffic_mode
                    ? this.field.traffic_mode
                    : "enabled",
                return:
        ...
        addRouteShapeToMap(result) {
            let draw_route =
                this.field.draw_route !== undefined
                    ? this.field.draw_route
                    : true;
            if (
         ...
         */
        addCirles() {
            console.log("calling add circles");
            console.log(this.field.circles);
        ...
        setMapInitPosition() {
            ...
            this.map.setZoom(
                this.field.zoom !== undefined ? this.field.zoom : 14
            );
        },
    ...
    mounted() {
        ...
        this.gps_points = this.field.gpsPoints.map(element =>
            JSON.parse(element)
        );
